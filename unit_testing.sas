...
*/
    %global ut_grp_id ut_grp_desc ut_seq ut_id ut_type ut_desc ut_exp_res ut_res ut_det ut_work_dir ut_log_file;
    ...
    *--
        ...
        Value is set when invoking "ut_init"
    ...
    *--
        ...
        Call to an assert function derive this value ut_grp_id.ut_seq
    --*;
    %let ut_id = ;
